...
define('composer', [
        ...
        */
        ...
        submitBtn.on('click', function (e) {
            ...
            if ($('#post_as_anon').is(':checked')) {
                console.log('The checkbox  checked');
            }
    ...
    async function post(post_uuid) {
        ...
        console.log('The checkbox is asjdkfjalksdjfljsadfchecked');
        ...
        /* const stage = new Iroh.stage(poststring);
        stage.addListener(Iroh.VAR).on('after', (e) => { // this logs the variable's 'name' and 'value'
